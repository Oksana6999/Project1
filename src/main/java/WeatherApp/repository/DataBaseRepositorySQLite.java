...
import WeatherApp.ApplicationGlobalState;
...
public class DataBaseRepositorySQLite implements DataBaseRepository {
    ...
    public boolean saveWeatherData(WeatherData weatherData) throws SQLException {
        ...
        throw new SQLException("Failure on saving weather.");
    }



    @Override
    public List<WeatherData> getAllSaveData() throws IOException, SQLException {
        ...
        while (resultSet.next()) {
            weatherDataList.add(new WeatherData(resultSet.getString(1),resultSet.getString(2), resultSet.getString(3),resultSet.getString(4),
